    ...
    children: [
      ...
      { path: 'patients',     loadComponent: () => import('./patients/patient-list/patient-list.component').then(c => c.PatientListComponent) },
      {
        ...
        children: [
          ...
          { path: 'records',       loadComponent: () => import('./patients/patient-records/patient-records.component').then(c => c.PatientRecordsComponent) },
          { path: 'tasks',         loadComponent: () => import('./patients/patient-tasks/patient-tasks.component').then(c => c.PatientTasksComponent) },
          { path: 'medications',   loadComponent: () => import('./patients/patient-medications/patient-medications.component').then(c => c.PatientMedicationsComponent) },
          { path: 'checklist',     loadComponent: () => import('./patients/patient-tasks/patient-tasks.component').then(c => c.PatientTasksComponent) },
        ],
      },
