...
<div class="page">
    ...
    <div class="profile-grid">
      ...
      <div class="col-right">
        ...
        <div class="info-card" *ngIf="editing()">
          ...
          <p class="note">Specialty, workplace, license and phone are set during registration.</p>
          <div class="f2">
  ...
  styles: [`
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .av-circle{width:84px;height:84px;border-radius:50%;background:#2D4A8A;color:#fff;font-size:28px;font-weight:700;display:flex;align-items:center;justify-content:center;}
    ...
    .av-spec{font-size:12px;color:#2D4A8A;font-weight:700;background:#EEF2FF;padding:3px 10px;border-radius:20px;}
    ...
    .il{font-size:13px;color:#6B7280;min-width:110px;flex-shrink:0;}
...
export class DoctorProfileComponent implements OnInit {
  ...
  save(): void {
    ...
    const body: any = {};
    if (this.form.firstName)      body.firstName         = this.form.firstName;
    if (this.form.lastName)       body.lastName          = this.form.lastName;
    if (this.form.email)          body.email             = this.form.email;
    if (this.avatarUrl())         body.profilePictureUrl = this.avatarUrl();
    if (this.form.education      !== undefined) body.education      = this.form.education;
    if (this.form.certifications !== undefined) body.certifications = this.form.certifications;
      ...
      next: (res: any) => {
        ...
        if (url) {
          ...
          this.svc.updateDoctorNurse({
            ...
            certifications:    this.certifications || undefined,
