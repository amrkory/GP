...
@Component({
      ...
      <ng-container *ngIf="!loading()">
        <div class="avatar-card">
          ...
          <div>
            ...
            <div class="arole">Nurse / Provider</div>
        ...
        <div class="info-card" *ngIf="!editing()">
          ...
          <div class="info-row"><span>Specialty</span><strong>{{ profile().specialtyName || profile().specialization || '—' }}</strong></div>
          ...
          <div class="info-row"><span>Status</span>
            <span class="status-badge" [class.active]="profile().isActive">{{ profile().isActive ? 'Active' : 'Inactive' }}</span>
          </div>
        </div>
  ...
  styles: [`
    ...
    .avatar{width:72px;height:72px;border-radius:50%;background:#0F6E56;color:#fff;font-size:24px;font-weight:700;display:flex;align-items:center;justify-content:center;}
    ...
    .aname{font-size:17px;font-weight:700;color:#111;}.arole{font-size:12px;color:#0F6E56;font-weight:600;margin:2px 0;}.aemail{font-size:13px;color:#888;}
    ...
    .btn-save{flex:2;padding:12px;background:#0F6E56;color:#fff;border:none;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;}
    ...
    .info-row{display:flex;justify-content:space-between;align-items:center;padding:12px 16px;border-bottom:1px solid #f5f5f5;font-size:14px;}
    .info-row:last-child{border-bottom:none;}.info-row span{color:#888;}.info-row strong{color:#111;}
    .status-badge{font-size:12px;padding:3px 10px;border-radius:10px;font-weight:600;background:#f0f0f0;color:#888;}
    .status-badge.active{background:#E1F5EE;color:#0F6E56;}
    .action-row{display:flex;gap:10px;}
    .btn-edit{flex:2;padding:13px;background:#0F6E56;color:#fff;border:none;border-radius:12px;font-size:15px;font-weight:600;cursor:pointer;}
    .btn-logout{flex:1;padding:13px;background:#E1F5EE;color:#0F6E56;border:none;border-radius:12px;font-size:15px;font-weight:600;cursor:pointer;}
  `],
})
