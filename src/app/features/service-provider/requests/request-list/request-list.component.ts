...
// 1. تم إضافة address و requestedTime وتعديل الأنواع لحل أخطاء NG9
...
@Component({
  ...
  template: `
    <div class="page">
      <div class="page-header">
        ...
        <p class="sub" *ngIf="!loading()">{{ all().length }} total · {{ countOf('Pending') }} pending</p>
      </div>
  ...
  styles: [`
    ...
    .page-header h1 { font-size:22px; font-weight:700; color:#111; margin-bottom:3px; }
